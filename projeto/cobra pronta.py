...
tamanho = 10
placar = 40
icon = pygame.image.load(os.path.join('imagens/padoru.GIF'))

relogio = pygame.time.Clock()
fundo = pygame.display.set_mode((largura,altura))
pygame.display.set_caption("Cobrinha Vrau Vrau!")
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    if x > 45 and y > 120 and x < 180 and y < 147:
                        ...
                        fimdejogo = False
            fundo.fill(branco)
            texto("Se Fudeu!", vermelho, 50, 65, 30)
            texto("Marcasse: "+str(pontos), preto, 30, 70, 80)
